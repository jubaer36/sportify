...
export default function ViewMatchResultPage() {
  ...
  const handleProceed = () => {
    ...
    if (selectedSportName.toLowerCase() === "cricket") {
      window.location.href = `/player/view-cricket-result?tournamentId=${selectedTournament.tournamentId}&matchId=${selectedMatchId}`;
    } else {
      window.location.href = `/player/view-score-result?tournamentId=${selectedTournament.tournamentId}&matchId=${selectedMatchId}`;
    }
  };

  return (
    <div className="view-match-result-bg">
      <Topbar />
      <div className="view-match-result-content">
        <h1 className="view-match-result-title">View Match Result</h1>
